...
public class MinValueDecorator extends DecoratorInterpreter {
    @Override
    ...
    private static void ensureFinite(Number n) {
     ...
     */
    private static Number extractSingleNumericArg(AnnotationDeclaration decl) {
        // Adjust to your AST:
