...
public final class AnnotationType extends Type {
    ...
    public AnnotationType(Collection<Type> params, Type returnType) {
        super();
    ...
    public static Object from(Collection<Type> params, Type type) {
        return new AnnotationType(params, type);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AnnotationType funType)) return false;
    ...
    public static AnnotationType valueOf(@NotBlank String symbol) {
        ...
        return new AnnotationType(paramsType, returnType);
    }
