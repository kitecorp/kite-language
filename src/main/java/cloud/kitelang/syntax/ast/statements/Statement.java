...
public abstract sealed class Statement implements Callstack
        permits ComponentStatement, InputDeclaration, OutputDeclaration, ResourceStatement, UnionTypeStatement, Program, EmptyStatement, ExpressionStatement, ForStatement, FunctionDeclaration, IfStatement, ImportStatement, InitStatement, ReturnStatement, SchemaDeclaration, StructDeclaration, ValStatement, VarStatement, WhileStatement {
