...
import static io.zmeu.Frontend.Parser.Statements.ObjectStatement.objectStatement;
...
public class ObjectExpressionTest extends ParserTest {
    ...
    void varInitToNumber() {
        ...
        var expected = program(varStatement(var(id("x"),
                block(objectStatement(object(id("a"), number(2)))))));
        assertEquals(expected, res);
        log.info((res));
    }
    ...
    void varInitToDecimal() {
        ...
        var expected = program(varStatement(var(id("x"),
                block(objectStatement(object(id("a"), number(2.2)))))));
        assertEquals(expected, res);
        log.info((res));
    }
    ...
    void varInitToTrue() {
        ...
        var expected = program(varStatement(var(id("x"),
                block(objectStatement(object(id("a"), bool(true)))))));
        assertEquals(expected, res);
        log.info((res));
    }
    ...
    void varInitToFalse() {
        ...
        var expected = program(varStatement(var(id("x"),
                block(objectStatement(object(id("a"), bool(false)))))));
        assertEquals(expected, res);
        log.info((res));
    }
    ...
    void varInitToNull() {
        ...
        var expected = program(varStatement(var(id("x"),
                block(objectStatement(object(id("a"), NullLiteral.nullLiteral()))))));
        assertEquals(expected, res);
        log.info((res));
    }
    ...
    void varInitToNesteObject() {
        var res = parse("""
                ...
                """);
        var expected = program(varStatement(var(id("x"),
                block(objectStatement(object(id("a"),
                        block(objectStatement(object(id("b"), number(2))))
                ))))));
        assertEquals(expected, res);
        log.info((res));
    }
    ...
    void varInitToString() {
        var res = parse("""
                ...
                """);
        var expected = program(varStatement(var(id("x"),
                block(objectStatement(object(id("a"), string("2")))))));
        assertEquals(expected, res);
        log.info((res));
    }
    ...
    void varInitToString2() {
        var res = parse("""
                ...
                """);
        var expected = program(varStatement(var(id("x"),
                block(objectStatement(object(id("a"), string("hello")))))));
        assertEquals(expected, res);
        log.info((res));
    }
